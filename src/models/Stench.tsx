...
import StenchInterface from '../interfaces/Stench';
import ModifiersInterface from '../interfaces/Modifiers';

export class Stench extends Potion implements StenchInterface {
    ...
    static create(ingredients: { effects: string[] }[]): Stench | null {
        ...
        const potionName: string = `Stench of ${weakestPrefix} Damage`; 
